                      ...
                      <div class="modal-content">
                        <div class="modal-body">
                          ...
                          <div class="panel-heading" align="center">
                            <h3 class="panel-title" ><font color="blue">Requisitos para el formulario</h3></font>
                            </div>
...
</div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Indica que falta cargar o poosee algun error en la carga<BR><BR>
<div class="glyphicon" style="height:10px; width:10px;">
                <span class="input-group-addon success"><span class="glyphicon glyphicon-ok"></span></span>
 </div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Indica que cargo correctamente el campo<br><br>
 <div class="glyphicon" style="height:10px; width:10px;">
                <span class="input-group-addon info"><span class="glyphicon glyphicon-asterisk"></span></span>
 </div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Indica que su carga es opcional
 <br><br>
                            ...
                            <button id="aceptar"> Tengo todos los formulario! </button></div>
                          </div>
                        </div>
                      </div>
                    </div>
