...
<script >
  function compfam(i, value) {
    ...
    if (value==="activosfam"+i) {
      ...
      $('#comprobanteIngresosfam'+i).html("<label  id='recibofam"+i+"' for='validate-number'>Declaración jurada especificando actividad laboral e ingresos mensuales</label><div id='imag"+(i+1)+"1' ><label class='label label-info' for='validate-number'>Comprobante:</label>   <div class='input-group'>  <input  type='file' id='familiar"+i+"comping1' name='familiar["+i+"][comping1]' accept='.jpg, .jpeg, .png' class='form-control' required> <span class='input-group-addon danger'><span class='glyphicon glyphicon-remove'></span></span> </div> </div><div id='list-familiar"+i+"comping1-1' style='display:none;' class='form-group'><div class='input-group'><img class='thumb' id='list-familiar"+i+"comping1' />   </div> </div></div><div  id='ingresosfamdiv"+i+"' class='form-group'> <label for='validate-number'>Ingresos:</label>   <div class='input-group' data-validate='number'><input   type='text' class='form-control' name='familiar["+i+"][ingresosfam]' id='familiar"+i+"ingresosfam' placeholder='Ingrese solo numeros' required><span class='input-group-addon danger'><span class='glyphicon glyphicon-remove'></span></span>  </div>"); 
