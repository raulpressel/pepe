...
<div class="col-sm-offset-2 col-sm-6">
        ...
        <div style="display:none;" id="imagencertificadodiv0" class="form-group">
            ...
            <div class="input-group">
              ...
              <div class="input-group">
                <img class="thumb" id="list-imagencertificado0" />
              </div>
            </div>
          </div>
          </div>
...
<br>
   ...
   <script>
        ...
        $('#incapacidad'+i).focus(function(){
          ...
          $('#imagencertificado'+i).html("<label for='validate-number'>Imagen Certificado:</label> <div class='input-group'> <input  type='file' id='imagencertificado"+i+"' name='consideraciones["+i+"][imagen]' accept='.jpg, .jpeg, .png' class='form-control' required> <span class='input-group-addon danger'><span class='glyphicon glyphicon-remove'></span></span> </div> <div class='input-group'> <img class='thumb' id='list-imagencertificado"+i+"' /> </div> </div>" ); 
