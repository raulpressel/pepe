      ...
      <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="input-group" data-validate="radio">
              <input value="{{ old('urbano') }}" value="Si" type="radio" name="urbano" id="urbanoSi"  required> Si 
              <input value="{{ old('urbano') }}" value="No" type="radio" name="urbano" id="urbanoNo" required> No <br>
      ...
      <div class="form-group">
              <label for="validate-letras">Cantidad de veces que viaja por semana:</label>
                <div class="input-group">
                  <select value="{{ old('cantviaja') }}" class="form-control" name="cantviaja" id="cantviaja" placeholder="Seleccione una opción" required>
        ...
        <div class="form-group">
          ...
          <br>
          <div class="input-group" data-validate="radio">
              <input value="{{ old('mediadist') }}" value="Si" type="radio" name="mediadist" id="mediadistSi"  required> Si 
              <input value="{{ old('mediadist') }}" value="No" type="radio" name="mediadist" id="mediadistNo" required> No <br>
            <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
          </div>
        </div>
