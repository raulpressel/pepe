...
$('#preciopasajediv').html("<label for='validate-number' class='label label-info'>Precio del Pasaje $:</label>          <div class='input-group' data-validate='number'>            <input   type='number' min='0' class='form-control' name='preciopasaje' id='preciopasaje' placeholder='Ingrese solo numeros' required>            <span class='input-group-addon danger'><span class='glyphicon glyphicon-remove'></span></span>          </div>");
$('#cantkmdiv').html("<label for='validate-number' class='label label-info'>Cantidad de kilometros:</label>          <div class='input-group' data-validate='number'>            <input type='number' min='0' max='500' class='form-control' name='cantkm' id='cantkm' placeholder='Ingrese solo numeros' required>            <span class='input-group-addon danger'><span class='glyphicon glyphicon-remove'></span></span>          </div>        </div>");
$(document).ready(function() {
