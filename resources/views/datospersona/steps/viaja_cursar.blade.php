<div class="tab-pane" role="tabpanel" id="step5">
    <div class="container">
          ...
          <div class="form-group">
              <label for="validate-letras">Utiliza colectivos Urbanos:</label>
                <div class="input-group">
                  <select value="{{ old('urbano') }}" class="form-control" name="urbano" id="urbano" placeholder="Seleccione una opción" >
      ...
      <div style="display:none;" id="cantviajadiv" class="form-group">
              <label for="validate-letras">Cantidad de veces que viaja por semana:</label>
                <div class="input-group">
                  <select class="form-control" name="cantviaja" id="cantviaja" placeholder="Seleccione una opción" >
                    <option value="">Seleccione una opción</option>
        ...
        <div class="col-sm-offset-2 col-sm-6">
          ...
          <div class="form-group">
              <label for="validate-letras">Utiliza colectivos de Media Distancia:</label>
                <div class="input-group">
                  <select value="{{ old('mediadist') }}" class="form-control" name="mediadist" id="mediadist" placeholder="Seleccione una opción" >
                    <option value="">Seleccione una opción</option>
                    <option value="Si">Si</option><option value="No">No</option>
                </select>
                <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
  ...
  <div style="display:none;" id="cantviajamediadiv" class="form-group">
              <label for="validate-letras">Cantidad de veces que viaja por semana:</label>
                <div class="input-group">
                  <select value="{{ old('cantviajamedia') }}" class="form-control" name="cantviajamedia" id="cantviajamedia" placeholder="Seleccione una opción" >
                    <option value="">Seleccione una opción</option>
        ...
        <div style="display:none;" id="cantkmdiv" class="form-group">
          ...
          <div class="input-group" data-validate="number">
            <input value="{{ old('cantkilometros') }}"  type="number" min="0" max="500" class="form-control" name="cantkm" id="cantkm" placeholder="Ingrese solo numeros" >
            <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
          </div>
        </div>
