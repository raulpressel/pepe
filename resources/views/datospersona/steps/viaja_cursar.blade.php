    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="input-group" data-validate="radio">
              <input  type="radio" name="urbano" id="urbanoSi"  required> Si 
              <input  type="radio" name="urbano" id="urbanoNo" required> No <br>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <br>
          <div class="input-group" data-validate="radio">
              <input  type="radio" name="mediadist" id="mediadistSi"  required> Si 
              <input  type="radio" name="mediadist" id="mediadistNo" required> No <br>
            <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
          </div>
        </div>
       ...
       <div class="form-group">
          ...
          <div class="input-group" data-validate="number">
            <input type="number" class="form-control" name="preciopasaje" id="preciopasaje" placeholder="Ingrese solo numeros">
      ...
      <div class="form-group">
              <label for="validate-letras">Cantidad de veces que viaja por semana:</label>
                <div class="input-group">
                  <select class="form-control" name="cantviajamedia" id="cantviajamedia" placeholder="Seleccione una opción" required>
                    <option value="">Seleccione una opción</option>
